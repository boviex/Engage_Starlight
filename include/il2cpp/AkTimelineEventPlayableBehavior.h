...
bool AkTimelineEventPlayableBehavior__IsScrubbing (AkTimelineEventPlayableBehavior_o* __this, UnityEngine_Playables_Playable_o playable, UnityEngine_Playables_FrameData_o info, const MethodInfo* method);
void AkTimelineEventPlayableBehavior__PrintInfo (AkTimelineEventPlayableBehavior_o* __this, System_String_o* FunctionName, UnityEngine_Playables_Playable_o playable, UnityEngine_Playables_FrameData_o info, const MethodInfo* method);
