...
void System_Console__WriteLine (System_String_o* value, const MethodInfo* method);
void System_Console__WriteLine (System_String_o* format, Il2CppObject* arg0, const MethodInfo* method);
