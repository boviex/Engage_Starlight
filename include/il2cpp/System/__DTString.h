...
void System___DTString___ctor (System___DTString_o __this, System_String_o* str, System_Globalization_DateTimeFormatInfo_o* dtfi, bool checkDigitToken, const MethodInfo* method);
...
System_Globalization_CompareInfo_o* System___DTString__get_CompareInfo (System___DTString_o __this, const MethodInfo* method);
...
bool System___DTString__MatchSpecifiedWord (System___DTString_o __this, System_String_o* target, const MethodInfo* method);
bool System___DTString__MatchSpecifiedWord (System___DTString_o __this, System_String_o* target, int32_t endIndex, const MethodInfo* method);
...
bool System___DTString__Match (System___DTString_o __this, System_String_o* str, const MethodInfo* method);
bool System___DTString__Match (System___DTString_o __this, uint16_t ch, const MethodInfo* method);
int32_t System___DTString__MatchLongestWords (System___DTString_o __this, System_String_array* words, int32_t* maxMatchStrLen, const MethodInfo* method);
int32_t System___DTString__GetRepeatCount (System___DTString_o __this, const MethodInfo* method);
...
void System___DTString__TrimTail (System___DTString_o __this, const MethodInfo* method);
void System___DTString__RemoveTrailingInQuoteSpaces (System___DTString_o __this, const MethodInfo* method);
void System___DTString__RemoveLeadingInQuoteSpaces (System___DTString_o __this, const MethodInfo* method);
