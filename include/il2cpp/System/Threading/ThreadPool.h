...
System_Threading_RegisteredWaitHandle_o* System_Threading_ThreadPool__RegisterWaitForSingleObject (System_Threading_WaitHandle_o* waitObject, System_Threading_WaitOrTimerCallback_o* callBack, Il2CppObject* state, int32_t millisecondsTimeOutInterval, bool executeOnlyOnce, const MethodInfo* method);
...
bool System_Threading_ThreadPool__QueueUserWorkItem (System_Threading_WaitCallback_o* callBack, const MethodInfo* method);
