...
void System_Threading_ExecutionContext__SetLocalValue (System_Threading_IAsyncLocal_o* local, Il2CppObject* newValue, bool needChangeNotifications, const MethodInfo* method);
...
System_Threading_AsyncFlowControl_o System_Threading_ExecutionContext__SuppressFlow (const MethodInfo* method);
void System_Threading_ExecutionContext__RestoreFlow (const MethodInfo* method);
