...
bool System_Threading_RegisteredWaitHandle__Unregister (System_Threading_RegisteredWaitHandle_o* __this, System_Threading_WaitHandle_o* waitObject, const MethodInfo* method);
