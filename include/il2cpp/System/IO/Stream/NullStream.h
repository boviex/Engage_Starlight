...
System_Threading_Tasks_Task_int__o* System_IO_Stream_NullStream__ReadAsync (System_IO_Stream_NullStream_o* __this, System_Byte_array* buffer, int32_t offset, int32_t count, System_Threading_CancellationToken_o cancellationToken, const MethodInfo* method);
...
System_Threading_Tasks_Task_o* System_IO_Stream_NullStream__WriteAsync (System_IO_Stream_NullStream_o* __this, System_Byte_array* buffer, int32_t offset, int32_t count, System_Threading_CancellationToken_o cancellationToken, const MethodInfo* method);
...
void System_IO_Stream_NullStream__SetLength (System_IO_Stream_NullStream_o* __this, int64_t length, const MethodInfo* method);
