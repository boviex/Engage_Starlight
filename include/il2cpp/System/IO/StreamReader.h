...
void System_IO_StreamReader___ctor (System_IO_StreamReader_o* __this, System_IO_Stream_o* stream, System_Text_Encoding_o* encoding, bool detectEncodingFromByteOrderMarks, const MethodInfo* method);
...
void System_IO_StreamReader__Close (System_IO_StreamReader_o* __this, const MethodInfo* method);
void System_IO_StreamReader__Dispose (System_IO_StreamReader_o* __this, bool disposing, const MethodInfo* method);
System_Text_Encoding_o* System_IO_StreamReader__get_CurrentEncoding (System_IO_StreamReader_o* __this, const MethodInfo* method);
System_IO_Stream_o* System_IO_StreamReader__get_BaseStream (System_IO_StreamReader_o* __this, const MethodInfo* method);
bool System_IO_StreamReader__get_LeaveOpen (System_IO_StreamReader_o* __this, const MethodInfo* method);
bool System_IO_StreamReader__get_EndOfStream (System_IO_StreamReader_o* __this, const MethodInfo* method);
...
int32_t System_IO_StreamReader__ReadBlock (System_IO_StreamReader_o* __this, System_Char_array* buffer, int32_t index, int32_t count, const MethodInfo* method);
