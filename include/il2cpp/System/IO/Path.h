...
System_String_o* System_IO_Path__GetExtension (System_String_o* path, const MethodInfo* method);
...
System_String_o* System_IO_Path__GetTempFileName (const MethodInfo* method);
System_String_o* System_IO_Path__GetTempPath (const MethodInfo* method);
System_String_o* System_IO_Path__get_temp_path (const MethodInfo* method);
