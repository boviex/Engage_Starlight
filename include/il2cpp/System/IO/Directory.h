...
System_String_array* System_IO_Directory__GetFiles (System_String_o* path, System_String_o* searchPattern, const MethodInfo* method);
...
System_Collections_Generic_IEnumerable_string__o* System_IO_Directory__EnumerateFiles (System_String_o* path, System_String_o* searchPattern, int32_t searchOption, const MethodInfo* method);
System_Collections_Generic_IEnumerable_string__o* System_IO_Directory__InternalEnumerateFiles (System_String_o* path, System_String_o* searchPattern, int32_t searchOption, const MethodInfo* method);
System_Collections_Generic_IEnumerable_string__o* System_IO_Directory__EnumerateFileSystemNames (System_String_o* path, System_String_o* searchPattern, int32_t searchOption, bool includeFiles, bool includeDirs, const MethodInfo* method);
