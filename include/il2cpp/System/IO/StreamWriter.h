...
void System_IO_StreamWriter___ctor (System_IO_StreamWriter_o* __this, System_IO_Stream_o* stream, System_Text_Encoding_o* encoding, const MethodInfo* method);
...
void System_IO_StreamWriter___ctor (System_IO_StreamWriter_o* __this, System_String_o* path, const MethodInfo* method);
...
void System_IO_StreamWriter__Close (System_IO_StreamWriter_o* __this, const MethodInfo* method);
...
System_Text_Encoding_o* System_IO_StreamWriter__get_Encoding (System_IO_StreamWriter_o* __this, const MethodInfo* method);
