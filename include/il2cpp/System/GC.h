...
void System_GC__Collect (int32_t generation, int32_t mode, const MethodInfo* method);
void System_GC__Collect (int32_t generation, int32_t mode, bool blocking, const MethodInfo* method);
void System_GC__Collect (int32_t generation, int32_t mode, bool blocking, bool compacting, const MethodInfo* method);
...
void System_GC__WaitForPendingFinalizers (const MethodInfo* method);
