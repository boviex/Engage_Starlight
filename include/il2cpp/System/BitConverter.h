...
System_Byte_array* System_BitConverter__GetBytes (bool value, const MethodInfo* method);
System_Byte_array* System_BitConverter__GetBytes (uint16_t value, const MethodInfo* method);
...
System_Byte_array* System_BitConverter__GetBytes (uint16_t value, const MethodInfo* method);
System_Byte_array* System_BitConverter__GetBytes (uint32_t value, const MethodInfo* method);
System_Byte_array* System_BitConverter__GetBytes (float value, const MethodInfo* method);
uint16_t System_BitConverter__ToChar (System_Byte_array* value, int32_t startIndex, const MethodInfo* method);
...
bool System_BitConverter__ToBoolean (System_Byte_array* value, int32_t startIndex, const MethodInfo* method);
