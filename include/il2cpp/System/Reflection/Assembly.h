...
System_IO_Stream_o* System_Reflection_Assembly__GetManifestResourceStream (System_Reflection_Assembly_o* __this, System_String_o* name, const MethodInfo* method);
...
System_Type_o* System_Reflection_Assembly__GetType (System_Reflection_Assembly_o* __this, System_String_o* name, bool throwOnError, const MethodInfo* method);
...
System_String_array* System_Reflection_Assembly__GetManifestResourceNames (System_Reflection_Assembly_o* __this, const MethodInfo* method);
...
bool System_Reflection_Assembly__GetManifestResourceInfoInternal (System_Reflection_Assembly_o* __this, System_String_o* name, System_Reflection_ManifestResourceInfo_o* info, const MethodInfo* method);
System_Reflection_ManifestResourceInfo_o* System_Reflection_Assembly__GetManifestResourceInfo (System_Reflection_Assembly_o* __this, System_String_o* resourceName, const MethodInfo* method);
