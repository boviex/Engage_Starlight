...
System_String_o* System_ParseNumbers__LongToString (int64_t value, int32_t toBase, int32_t width, uint16_t paddingChar, int32_t flags, const MethodInfo* method);
