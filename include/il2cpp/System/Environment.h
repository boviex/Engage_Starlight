...
System_String_o* System_Environment__get_MachineName (const MethodInfo* method);
...
System_String_o* System_Environment__get_UserDomainName (const MethodInfo* method);
System_String_o* System_Environment__get_UserName (const MethodInfo* method);
...
System_String_array* System_Environment__GetCommandLineArgs (const MethodInfo* method);
...
System_Collections_IDictionary_o* System_Environment__GetEnvironmentVariables (const MethodInfo* method);
...
bool System_Environment__get_IsUnix (const MethodInfo* method);
