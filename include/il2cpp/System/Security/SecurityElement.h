...
System_Security_SecurityElement_o* System_Security_SecurityElement__SearchForChildByTag (System_Security_SecurityElement_o* __this, System_String_o* tag, const MethodInfo* method);
...
void System_Security_SecurityElement__set_m_strText (System_Security_SecurityElement_o* __this, System_String_o* value, const MethodInfo* method);
System_String_o* System_Security_SecurityElement__SearchForTextOfLocalName (System_Security_SecurityElement_o* __this, System_String_o* strLocalName, const MethodInfo* method);
