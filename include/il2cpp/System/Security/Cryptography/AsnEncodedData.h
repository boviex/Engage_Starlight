...
void System_Security_Cryptography_AsnEncodedData___ctor (System_Security_Cryptography_AsnEncodedData_o* __this, System_Security_Cryptography_Oid_o* oid, System_Byte_array* rawData, const MethodInfo* method);
