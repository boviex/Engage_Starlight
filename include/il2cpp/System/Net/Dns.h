...
bool System_Net_Dns__GetHostName_internal (System_String_o** h_name, const MethodInfo* method);
...
System_String_o* System_Net_Dns__GetHostName (const MethodInfo* method);
