...
void System_TermInfoReader__DetermineVersion (System_TermInfoReader_o* __this, int16_t magic, const MethodInfo* method);
...
int32_t System_TermInfoReader__GetInt32 (System_TermInfoReader_o* __this, System_Byte_array* buffer, int32_t offset, const MethodInfo* method);
int32_t System_TermInfoReader__GetInteger (System_TermInfoReader_o* __this, System_Byte_array* buffer, int32_t offset, const MethodInfo* method);
