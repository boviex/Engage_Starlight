...
void System_Guid___ctor (System_Guid_o __this, int32_t a, int16_t b, int16_t c, System_Byte_array* d, const MethodInfo* method);
void System_Guid___ctor (System_Guid_o __this, int32_t a, int16_t b, int16_t c, uint8_t d, uint8_t e, uint8_t f, uint8_t g, uint8_t h, uint8_t i, uint8_t j, uint8_t k, const MethodInfo* method);
...
bool System_Guid__TryParse (System_String_o* input, System_Guid_o* result, const MethodInfo* method);
