...
Il2CppObject* System_Text_RegularExpressions_GroupCollection__get_SyncRoot (System_Text_RegularExpressions_GroupCollection_o* __this, const MethodInfo* method);
bool System_Text_RegularExpressions_GroupCollection__get_IsSynchronized (System_Text_RegularExpressions_GroupCollection_o* __this, const MethodInfo* method);
...
System_Text_RegularExpressions_Group_o* System_Text_RegularExpressions_GroupCollection__get_Item (System_Text_RegularExpressions_GroupCollection_o* __this, System_String_o* groupname, const MethodInfo* method);
