...
System_String_o* System_Text_RegularExpressions_RegexReplacement__Replace (System_Text_RegularExpressions_MatchEvaluator_o* evaluator, System_Text_RegularExpressions_Regex_o* regex, System_String_o* input, int32_t count, int32_t startat, const MethodInfo* method);
