...
void UnityEngine_Timeline_TimelineAsset__UpdateFixedDurationWithItemsDuration (UnityEngine_Timeline_TimelineAsset_o* __this, const MethodInfo* method);
UnityEngine_Timeline_DiscreteTime_o UnityEngine_Timeline_TimelineAsset__CalculateItemsDuration (UnityEngine_Timeline_TimelineAsset_o* __this, const MethodInfo* method);
...
Il2CppObject* UnityEngine_Timeline_TimelineAsset__CreateTrack_object_ (UnityEngine_Timeline_TimelineAsset_o* __this, UnityEngine_Timeline_TrackAsset_o* parent, System_String_o* trackName, const MethodInfo_2069E30* method);
Il2CppObject* UnityEngine_Timeline_TimelineAsset__CreateTrack_object_ (UnityEngine_Timeline_TimelineAsset_o* __this, System_String_o* trackName, const MethodInfo_2069D50* method);
Il2CppObject* UnityEngine_Timeline_TimelineAsset__CreateTrack_object_ (UnityEngine_Timeline_TimelineAsset_o* __this, const MethodInfo_2069C60* method);
