...
void UnityEngine_UI_VertexHelper__AddVert (UnityEngine_UI_VertexHelper_o* __this, UnityEngine_Vector3_o position, UnityEngine_Color32_o color, UnityEngine_Vector4_o uv0, UnityEngine_Vector4_o uv1, UnityEngine_Vector4_o uv2, UnityEngine_Vector4_o uv3, UnityEngine_Vector3_o normal, UnityEngine_Vector4_o tangent, const MethodInfo* method);
void UnityEngine_UI_VertexHelper__AddVert (UnityEngine_UI_VertexHelper_o* __this, UnityEngine_Vector3_o position, UnityEngine_Color32_o color, UnityEngine_Vector4_o uv0, UnityEngine_Vector4_o uv1, UnityEngine_Vector3_o normal, UnityEngine_Vector4_o tangent, const MethodInfo* method);
void UnityEngine_UI_VertexHelper__AddVert (UnityEngine_UI_VertexHelper_o* __this, UnityEngine_Vector3_o position, UnityEngine_Color32_o color, UnityEngine_Vector4_o uv0, const MethodInfo* method);
