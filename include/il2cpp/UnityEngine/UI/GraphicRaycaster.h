...
UnityEngine_LayerMask_o UnityEngine_UI_GraphicRaycaster__get_blockingMask (UnityEngine_UI_GraphicRaycaster_o* __this, const MethodInfo* method);
void UnityEngine_UI_GraphicRaycaster__set_blockingMask (UnityEngine_UI_GraphicRaycaster_o* __this, UnityEngine_LayerMask_o value, const MethodInfo* method);
