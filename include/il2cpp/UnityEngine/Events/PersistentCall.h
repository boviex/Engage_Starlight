...
System_String_o* UnityEngine_Events_PersistentCall__get_targetAssemblyTypeName (UnityEngine_Events_PersistentCall_o* __this, const MethodInfo* method);
...
void UnityEngine_Events_PersistentCall__OnBeforeSerialize (UnityEngine_Events_PersistentCall_o* __this, const MethodInfo* method);
void UnityEngine_Events_PersistentCall__OnAfterDeserialize (UnityEngine_Events_PersistentCall_o* __this, const MethodInfo* method);
