...
System_Reflection_MethodInfo_o* UnityEngine_Events_UnityEventBase__FindMethod (UnityEngine_Events_UnityEventBase_o* __this, System_String_o* name, System_Type_o* listenerType, int32_t mode, System_Type_o* argumentType, const MethodInfo* method);
...
System_Reflection_MethodInfo_o* UnityEngine_Events_UnityEventBase__GetValidMethodInfo (System_Type_o* objectType, System_String_o* functionName, System_Type_array* argumentTypes, const MethodInfo* method);
