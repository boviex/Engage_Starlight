...
System_Byte_array* UnityEngine_WWWTranscoder__DataEncode (System_Byte_array* toEncode, const MethodInfo* method);
System_String_o* UnityEngine_WWWTranscoder__QPEncode (System_String_o* toEncode, System_Text_Encoding_o* e, const MethodInfo* method);
...
bool UnityEngine_WWWTranscoder__SevenBitClean (System_String_o* s, System_Text_Encoding_o* e, const MethodInfo* method);
bool UnityEngine_WWWTranscoder__SevenBitClean (System_Byte_array* input, const MethodInfo* method);
