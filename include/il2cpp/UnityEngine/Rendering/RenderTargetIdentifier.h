...
void UnityEngine_Rendering_RenderTargetIdentifier___ctor (UnityEngine_Rendering_RenderTargetIdentifier_o __this, int32_t nameID, int32_t mipLevel, int32_t cubeFace, int32_t depthSlice, const MethodInfo* method);
void UnityEngine_Rendering_RenderTargetIdentifier___ctor (UnityEngine_Rendering_RenderTargetIdentifier_o __this, UnityEngine_Rendering_RenderTargetIdentifier_o renderTargetIdentifier, int32_t mipLevel, int32_t cubeFace, int32_t depthSlice, const MethodInfo* method);
...
void UnityEngine_Rendering_RenderTargetIdentifier___ctor (UnityEngine_Rendering_RenderTargetIdentifier_o __this, UnityEngine_Texture_o* tex, int32_t mipLevel, int32_t cubeFace, int32_t depthSlice, const MethodInfo* method);
...
bool UnityEngine_Rendering_RenderTargetIdentifier__op_Inequality (UnityEngine_Rendering_RenderTargetIdentifier_o lhs, UnityEngine_Rendering_RenderTargetIdentifier_o rhs, const MethodInfo* method);
