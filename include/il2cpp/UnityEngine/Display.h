...
bool UnityEngine_Display__get_requiresSrgbBlitToBackbuffer (UnityEngine_Display_o* __this, const MethodInfo* method);
...
bool UnityEngine_Display__RequiresSrgbBlitToBackbufferImpl (intptr_t nativeDisplay, const MethodInfo* method);
