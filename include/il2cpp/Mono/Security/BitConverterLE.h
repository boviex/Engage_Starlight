...
System_Byte_array* Mono_Security_BitConverterLE__GetULongBytes (uint8_t* bytes, const MethodInfo* method);
System_Byte_array* Mono_Security_BitConverterLE__GetBytes (int32_t value, const MethodInfo* method);
System_Byte_array* Mono_Security_BitConverterLE__GetBytes (int64_t value, const MethodInfo* method);
void Mono_Security_BitConverterLE__UShortFromBytes (uint8_t* dst, System_Byte_array* src, int32_t startIndex, const MethodInfo* method);
void Mono_Security_BitConverterLE__UIntFromBytes (uint8_t* dst, System_Byte_array* src, int32_t startIndex, const MethodInfo* method);
uint16_t Mono_Security_BitConverterLE__ToUInt16 (System_Byte_array* value, int32_t startIndex, const MethodInfo* method);
uint32_t Mono_Security_BitConverterLE__ToUInt32 (System_Byte_array* value, int32_t startIndex, const MethodInfo* method);
